    ...
    <c:if test="${role.equals('patient')}">
        <div class="bd-example" data-example-id="">
            <div class="list-group">
                ...
                <a href="<c:url value="/do/event/details?id=${event.id}"/>" class="list-group-item list-group-item-action">${msgVisit} ${sessionScope.patientDoctorSurname} ${msgV} ${event.eventDate} </a>
                </c:forEach>
            </div>
        </div>
    </c:if>
